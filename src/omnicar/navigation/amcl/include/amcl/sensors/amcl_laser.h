...
class AMCLLaser : public AMCLSensor
{
  ...
  // 用于申请辅助数据的内存，用于波束过滤时缓存测量数据
  private: void reallocTempData(int max_samples, int max_obs);

  private: laser_model_t model_type;  // 观测模型
