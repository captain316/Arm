...
// 一个集群，就是把pose视为三维点，27个方格内挨着的点都算一个集群
// 在pf_kdtree.h中有函数计算这个
typedef struct
{
  // Number of samples
  int count;  // 簇的粒子数量
...
typedef struct _pf_t
{
  ...
  double w_slow, w_fast;        // 用于判断是否需要随机撒点
