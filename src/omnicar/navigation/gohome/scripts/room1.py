...
class NavTest():  
    def __init__(self):  
        ...
        locations['p1'] = Pose(Point(3.589, -5.300, 0.000), Quaternion(0.000, 0.000, -0.717, 0.697))  
        # locations['p2'] = Pose(Point(-7.066, 6.324, 0.000), Quaternion(0.000, 0.000, -0.703, 0.711))  
        locations['p2'] = Pose(Point(3.692, -0.452, 0.000), Quaternion(0.000, 0.000, 0.712, 0.703)) 
        locations['p3'] = Pose(Point(0.000, 0.000, 0.000), Quaternion(0.000, 0.000, 0.000, 1.000)) 
